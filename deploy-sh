...
EOF
  ...
  echo "⚠️  IMPORTANT: Edit $TFVARS_FILE to set your actual values before applying!"
  echo ""
...
EOF
  ...
  echo "⚠️  IMPORTANT: Edit $TFVARS_FILE to set your actual Green AMI ID before applying!"
  echo ""
  echo "Then run: terraform apply"
}
...
EOF
  ...
  echo "⚠️  This will destroy the Blue instance!"
}
